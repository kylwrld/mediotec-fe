...
function TeacherController({
    ...
    async function fetchTeacherSubject() {
        ...
        const data = await (
            await getRequest(`http://192.168.1.9:8000/teacher/${teacher_id}/subjects/`)
        ).json();
    ...
    async function fetchSubjects() {
        if (subjects.length == 0) {
            const data = await (await getRequest("http://192.168.1.9:8000/subject/")).json();
    ...
    async function attachSubject(teacher_id, subject_id) {
        ...
        const res = await postRequest("http://192.168.1.9:8000/teacher_subject/", data);
    ...
    async function attachClass(class_id, teacherSubject_id) {
        ...
        const res = await postRequest("http://192.168.1.9:8000/class_year_teacher_subject/", data);
        if (res.ok) {
            toast({
                variant: "success",
    ...
    async function onSubmit(user) {
        ...
        user.type = "TEACHER";
        const res = await postRequest("http://192.168.1.9:8000/signup/", user);
