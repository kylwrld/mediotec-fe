...
function TeacherController({
    ...
    async function fetchTeacherSubject() {
        ...
        const data = await (
            await getRequest(`mascate-be.onrender.com/teacher/${teacher_id}/subjects/`)
        ).json();
    ...
    async function fetchSubjects() {
        if (subjects.length == 0) {
            const data = await (await getRequest("mascate-be.onrender.com/subject/")).json();
    ...
    async function attachSubject(teacher_id, subject_id) {
        ...
        const res = await postRequest("mascate-be.onrender.com/teacher_subject/", data);
    ...
    async function attachClass(class_id, teacherSubject_id) {
        ...
        const res = await postRequest("mascate-be.onrender.com/class_year_teacher_subject/", data);
        if (res.ok) {
            toast({
                variant: "success",
    ...
    async function onSubmit(user) {
        ...
        user.type = "TEACHER";
        const res = await postRequest("mascate-be.onrender.com/signup/", user);
