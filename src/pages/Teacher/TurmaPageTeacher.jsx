...
function TurmaPageTeacher() {
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            const response = await getRequest(`mascate-be.onrender.com/student_class/${id}/2024/`);
        ...
        const fetchSubjects = async () => {
            // const response = await getRequest(`mascate-be.onrender.com/teacher/${user.id}/subjects/`);
            // TODO: Change year variable to be dinamic
            const response = await getRequest(`mascate-be.onrender.com/teacher/${id}/${2024}/${user.id}`);
            const data = await response.json();
    ...
    async function fetchGrades(student_id) {
        const response = await getRequest(`mascate-be.onrender.com/grade/${student_id}/2024/`);
        const data = await response.json();
    ...
    async function submitGrades(grades) {
        ...
        const res = await postRequest("mascate-be.onrender.com/grade/", { grade: data });
