...
function DisciplinaPageAdmin() {
    ...
    useEffect(() => {
        const fetchSubject = async () => {
            const response = await getRequest(`https://mediotec-fe.onrender.com/subject/${id}/`);
            const data = await response.json();
            setSubject(data);
        };
        const fetchTeacherSubjects = async () => {
            const response = await getRequest(`https://mediotec-fe.onrender.com/subject/${id}/teachers/`);
            const data = await response.json();
