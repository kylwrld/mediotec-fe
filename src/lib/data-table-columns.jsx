            ...
            cell: ({ row }) => (
                <div className="capitalize text-center">
                    <Select
                        ...
                        <SelectTrigger className="text-sm border-0 shadow-none justify-center">
                            <SelectValue
...
export const gradeColumnsAdmin = [
    {
        accessorKey: "teacher_subject",
        header: <div className="text-center">Disciplina</div>,
        cell: ({ row }) => <div className="capitalize text-left">{row.original.teacher_subject.subject.name}</div>,
    },
    {
        accessorKey: "av1_1",
        header: <div className="text-center">AV1</div>,
        cell: ({ row }) => <div className="capitalize text-center">{row.original.av1_1 || "-"}</div>,
    },
    {
        accessorKey: "av2_1",
        header: <div className="text-center">AV2</div>,
    ...
    {
        accessorKey: "noa_1",
        header: <div className="text-center">NOA</div>,
